...
A conditional probability is the probability of an event X occurring when a secondary event Y is true. Mathematically, it is represented as P(X | Y). This is read as "probability of X given/conditioned on Y". Si calcola come joint prob dei due eventi fratto la marginal dell'evento condizionante.
...
sum(y["age"] == "A") # quanti adulti sono stati catturati e registrati nel file
