...
Alcuni animali sono stati ricatturati molte volte e non possono quindi essere considerate tutte le volte in cui compaiono con lo stesso peso, si fa quindi una media del peso per individuo in funzione del numero di catture
...
The closer W is to 1, the more normal the sample is. These are the results of the Shapiro-Wilk normality test:
...
The test statistic is: $$ F = s^2_x/s^2_y $$ It has an F-distribution with n − 1 and m − 1 degrees of freedom.
